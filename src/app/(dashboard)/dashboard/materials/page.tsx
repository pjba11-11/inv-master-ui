...
export default function MaterialsPage() {
  ...
  if (loading) return (
    <div className="space-y-6">
      <PageHeader title="Materials" description="Manage your inventory materials">
        <Link href="/dashboard/materials/add"><Button variant="primary">Add Material</Button></Link>
      </PageHeader>
